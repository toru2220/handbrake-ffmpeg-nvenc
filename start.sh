...
FFMPEG_ENCODE_OPT_DEFAULT=${FFMPEG_ENCODE_OPT_DEFAULT:-"-movflags +faststart -map_metadata 0 -c:v h264_nvenc -profile:v high -level:v 4.0 -b_strategy 2 -bf 2 -flags cgop -coder ac -pix_fmt yuv420p -crf 32 -bufsize 16M -c:a mp3 -ac 1 -ar 22050 -b:a 96k"}
...
HANDBRAKE_TARGET_EXT_DEFAULT=${HANDBRAKE_TARGET_EXT_DEFAULT:-"ISO"}
